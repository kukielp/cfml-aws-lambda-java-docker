...
public class EventLambdaHandler implements RequestStreamHandler {
	...
	private static String eventCFCPath = "/var/task/cfml/Application.cfc";
	private static String eventCFCMethod = "fuselessEvent";

	private static App handler = null;
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context)
        ...
        try {
            CFMLEngine engine = CFMLEngineFactory.getInstance(App.getCFMLServlet().getServletConfig());
            HashMap attributes = new HashMap();
            attributes.put("lambdaContext", ctx);
            PageContext pc = engine.createPageContext(new java.io.File("/var/task/cfml/"), "localhost", "/index.cfm", "", null, null, null, attributes, null, Long.MAX_VALUE, true);
